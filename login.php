				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-dark">Welcome To Bisho High School Application Management
							</h2>
						</div>
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
									   <input class="btn  btn-lg btn-block" style="background-color:#7F5F95; color: #fff;" name="signin" id="signin" type="submit" value="Sign In">
									</div>
								</div>
							</div>
						</form>
