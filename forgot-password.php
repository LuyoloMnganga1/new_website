...
<body class="login-page">
	<div class="login-header box-shadow" style="background-color:#7F5F95; color: #fff;">
				...
				<div class="col-md-12 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-dark"> Bisho High School Forgot Password
							</h2> 
						</div>
														...
														<div class="weight-500 col-md-12">
															<div class="form-group">
																...
																<div class="input-group">
                                                                    ...
                                                                    <button class="btn form-control reveal1" style="background-color:#7F5F95; color: #fff;" type="button"><i class="fa fa-eye text-light"></i></button>
                                                                    </span>
                                                                </div>
															</div>
														</div>
														<div class="weight-500 col-md-12">
															<div class="form-group">
																...
																<div class="input-group">
                                                                    ...
                                                                    <span class="input-group-btn">
                                                                    <button class="btn form-control reveal2" style="background-color:#7F5F95; color: #fff;" type="button"><i class="fa fa-eye text-light"></i></button>
                                                                    </span>
                                                                </div>
															</div>
														</div>
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
									   <input class="btn  btn-lg btn-block" style="background-color:#7F5F95; color: #fff;"  name="new_update" id="new_update" type="submit" value="Change Password">
									</div>
								</div>
							</div>
						</form>
